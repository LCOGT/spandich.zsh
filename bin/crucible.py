...
SCRIPT_VERSION='e3abfcdc49cb927b623910d64c4e702e'
...
class Configuration(object):
    ...
    def fill_from_defaults(self):
        self.url, self.username = self.url or 'http://buildsba3.lco.gtn:8060/fisheye', self.username or 'spandich'
        return self
...
class P4Source(PatchSource):
    ...
    def get_patch(self):
        ...
        output = check_output([p4, '-z', 'tag', 'diff', '-du'])
